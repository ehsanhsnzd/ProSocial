...
<head>
    ...
    <title>My Welcome Email Template Subject</title>
    <!-- <style> -->
</head>
<body>
                ...
                <table align="center" class="container header float-center"><tbody><tr><td>
                            <table class="row"><tbody><tr>
                                    <th class="small-12 large-12 columns first last"><table><tr><th>
                                                    <h1 class="text-center">Welcome to Pro Social</h1>
                                                </th>
                ...
                <table align="center" class="container body-border float-center"><tbody><tr><td>
                            <table class="row"><tbody><tr>
                                    <th class="small-12 large-12 columns first last"><table><tr><th>
                                                    ...
                                                    <center data-parsed="">
                                                        <img src="http://localhost:8000/image/Social-logo.png" align="left" class="float-left">
                                                    </center>
                                                    ...
                                                    <center data-parsed="">
                                                        <table align="center" class="menu float-center"><tr><td><table><tr>
                                                                            <th class="menu-item float-center"><a href="#">PRO.Social.com</a></th>
